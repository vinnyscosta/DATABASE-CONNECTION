...
os.environ["DATABASE_PASSWORD"] = "sua_senha"
os.environ["DATABASE_BASENAME"] = "nome_do_banco"
...
def test_query_select():
    ...
    resultado = Database.query("SELECT 1 as test_col", one=True)
...
def test_query_fail():
    ...
    resultado = Database.query("SELECT * FROM tabela_inexistente")
